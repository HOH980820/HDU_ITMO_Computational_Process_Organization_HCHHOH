...
from src.test1.built import arrayoperations


class Testarrayoperations(unittest.TestCase):
    def test_size(self):
        dynamic_array = arrayoperations()
    ...
    def test_concatenate(self):
        x = [1, 2, 3]
        y = [4, 5, 6]
        dynamic_array_a = arrayoperations()
        dynamic_array_b = arrayoperations()
